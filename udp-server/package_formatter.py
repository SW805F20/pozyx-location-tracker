class PackageFormatter:
	...
	def format_anchor_position(self, time_stamp, id, pos_x, pos_y):
		"""
		...
		"""
		package = self.format_position(pos_y, pos_x, id, time_stamp, 0x0)
		return hex(package)

	def format_player_position(self, time_stamp, id, pos_x, pos_y):
		"""
		...
		"""
		package = self.format_position(pos_y, pos_x, id, time_stamp, 0x1)
		return hex(package) 

	def format_goal_position(self, time_stamp, teamId, pos_x, pos_y):
		"""
		...
		"""
		package = self.format_position(pos_y, pos_x, teamId, time_stamp, 0x2)
		return hex(package)
	...
	def format_position(self, pos_y, pos_x, id, time_stamp, package_type):
		"""
