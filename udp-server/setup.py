...
class Setup:
    ...
    def prompt_mock_data(self):
        ...
        if use_mock_data == "y":
            ...
            self.anchors.append(Anchor(0x676e, 0, 0, 0))
            self.anchors.append(Anchor(0x676c, 0, 2550, 0))
            self.anchors.append(Anchor(0x6738, 3675, 2550, 0))
            self.anchors.append(Anchor(0x6e2b, 3675, 0, 0))
